...
class SeatsAvailabilityTest extends TestCase
{
     ...
     * @test
     */
    public function it_can_be_created_for_a_given_conference_id_and_quantity_of_seats(): void
    {
     ...
     * @test
     */
    public function a_reservation_can_be_made_if_the_number_of_seats_doesnt_exceed_the_available_number(): void
    {
        $conferenceId = ConferenceId::fromString((string)Uuid::uuid4());
        $quantity = 10;
        $seatsAvailability = SeatsAvailability::create($conferenceId, $quantity);
     ...
     * @test
     */
    public function a_reservation_cant_be_made_if_the_number_of_seats_exceeds_the_available_number(): void
    {
        $conferenceId = ConferenceId::fromString((string)Uuid::uuid4());
        $quantity = 1;
        $seatsAvailability = SeatsAvailability::create($conferenceId, $quantity);
     ...
     * @test
     */
    public function a_reservation_cant_be_made_if_the_number_of_seats_exceeds_the_accumulated_available_number(): void
    {
        $conferenceId = ConferenceId::fromString((string)Uuid::uuid4());
     ...
     * @test
     */
    public function cancelling_a_reservation_frees_up_the_number_of_seats_available(): void
    {
        $conferenceId = ConferenceId::fromString((string)Uuid::uuid4());
